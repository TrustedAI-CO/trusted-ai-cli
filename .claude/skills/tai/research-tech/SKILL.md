...
`~/.claude/skills/tai/research-tech`.
...
```bash
cat "${SKILL_DIR}/templates/comparison-matrix.md" 2>/dev/null || cat ~/.claude/skills/tai/research-tech/templates/comparison-matrix.md 2>/dev/null
```
...
```bash
cat "${SKILL_DIR}/templates/architecture-decision-record.md" 2>/dev/null || cat ~/.claude/skills/tai/research-tech/templates/architecture-decision-record.md 2>/dev/null
```
...
```bash
cat "${SKILL_DIR}/templates/deep-dive-summary.md" 2>/dev/null || cat ~/.claude/skills/tai/research-tech/templates/deep-dive-summary.md 2>/dev/null
```
...
```bash
cat "${SKILL_DIR}/templates/troubleshooting-report.md" 2>/dev/null || cat ~/.claude/skills/tai/research-tech/templates/troubleshooting-report.md 2>/dev/null
```
...
```bash
cat "${SKILL_DIR}/references/research-quality-checklist.md" 2>/dev/null || cat ~/.claude/skills/tai/research-tech/references/research-quality-checklist.md 2>/dev/null
```
